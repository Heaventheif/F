...
const CACHE_ROOT = path.join(MODULE_DIR, "..", "..", "cache");
...
function listCommandFiles() {
    const commandsRoot = path.join(MODULE_DIR, "..");
    const out = [];
    try {
...
export const $plugin = {
  name: 'xx-commands-media-up',
  meta: { category: 'command-media', path: 'src/commands/media/up.js' },
  setup(_ctx) {
    // see module exports
  },
};
